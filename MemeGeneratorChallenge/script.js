...
// container.appendChild(newElement); // <img src="https://i.redd.it/a0v87gwzoge61.jpg"></img>
...
function showJoke() {
  ...
  const container1 = document.querySelector('.joke-content');
  const newJoke = document.createElement('p');
  newJoke.textContent = randomJokeText;
  clearAll();
  container1.appendChild(newJoke);  
...
function showQuote() {
  ...
  const container2 = document.querySelector(".quote-content");
  ...
  clearAll();
  container2.appendChild(newQuote);
  container2.appendChild(newQuote2);
}
...
function showRiddle() {
  ...
  const container3 = document.querySelector('.riddle-content');
  const newRiddle = document.createElement('p');
  const newRiddle1 = document.createElement('p');
  newRiddle.textContent = randomRiddle.question;
  newRiddle1.textContent = "-" + randomRiddle.answer;
  newRiddle1.setAttribute("id", "riddle-answer");
clearAll();
newRiddle1.hidden = true;   
container3.appendChild(newRiddle);
container3.appendChild(newRiddle1);
